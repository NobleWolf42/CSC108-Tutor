...
!(function (e, t) {
            ...
            return (
                e.forEach((e) => {
                    ...
                    if (
                        ...
                        const t =
                            this.defaults.renderer || new ie(this.defaults);
                    ...
                    if (e.tokenizer) {
                        const t =
                            this.defaults.tokenizer || new se(this.defaults);
    ...
    (pe.options = pe.setOptions =
        ...
        (pe.use = function (...e) {
            return (
                he.use(...e), (pe.defaults = he.defaults), n(pe.defaults), pe
            );
        }),
